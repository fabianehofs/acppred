...
class Model:
    ...
    def transform(self, X):
        """
        Transform a set of protein sequences to aminoacid percents
    ...
    def predict(self, sequence):
        """
        Predicts the anticancer activity for gien peptide

        Args:
            - sequence: a peptide sequence to e analysed
        """ 
